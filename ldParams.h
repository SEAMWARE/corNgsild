...
#define LD_PARAMS_PATCH_ENTITY_ATTR      ( LD_PARAM_TYPE | LD_PARAM_LOCAL | LD_PARAM_OBSERVED_AT )
...
#define LD_PARAMS_GET_SUBSCRIPTION     ( LD_PARAM_OPTIONS | LD_PARAM_SYSATTRS )
...
#define LD_PARAMS_GET_CSOURCE_SUBSCRIPTION     ( LD_PARAM_OPTIONS | LD_PARAM_SYSATTRS )
...
#define LD_PARAMS_GET_CSOURCE_REGISTRATION    ( LD_PARAM_OPTIONS | LD_PARAM_SYSATTRS )
